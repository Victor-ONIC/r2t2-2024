 ...
 * Review : 06/05/2024 V3.7 Fix bad claw grip strength causing reboot
                            Add PAMI calls
 * Review : 10/05/2024 V4   Reduce acceleration ramp
 *                          Move BX and BY TOFs to FZ
 * 
...
#define MAXSPEED 3000 //V2 4000 V3  // V3.7 6000
#define ACCELERATION 1000 //V2 1000 V3  //  V3.7 2000
